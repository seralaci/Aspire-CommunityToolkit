...
| - **Learn More**: [`Hosting.InfluxDB`][influxdb-ext-integration-docs] <br /> - Stable 📦: [![CommunityToolkit.Aspire.Hosting.InfluxDB][influxdb-ext-shields]][influxdb-ext-nuget] <br /> - Preview 📦: [![CommunityToolkit.Aspire.Hosting.InfluxDB][influxdb-ext-shields-preview]][influxdb-ext-nuget-preview]                                                                                | An Aspire integration leveraging the [MailPit](https://mailpit.axllent.org/) container.                                                                                                                                        |
...
[influxdb-ext-integration-docs]: https://learn.microsoft.com/dotnet/aspire/community-toolkit/hosting-influxdb
[influxdb-ext-shields]: https://img.shields.io/nuget/v/CommunityToolkit.Aspire.Hosting.InfluxDB
[influxdb-ext-nuget]: https://nuget.org/packages/CommunityToolkit.Aspire.Hosting.InfluxDB/
[influxdb-ext-shields-preview]: https://img.shields.io/nuget/vpre/CommunityToolkit.Aspire.Hosting.InfluxDB?label=nuget%20(preview)
[influxdb-ext-nuget-preview]: https://nuget.org/packages/CommunityToolkit.Aspire.Hosting.InfluxDB/absoluteLatest
